...
class CreateCourseExerciseFormComponent(BaseComponent):
    def __init__(self, page: Page):
        ...
        self.delete_exercise_button = Button(
            page, locator='create-course-exercise-{index}-box-toolbar-delete-exercise-button', name='Delete exercise'
        )
        self.subtitle = Text(
            page, locator='create-course-exercise-{index}-box-toolbar-subtitle-text', name='Exercise subtitle'
        )
        self.title_input = Input(
            page, locator='create-course-exercise-form-title-{index}-input', name='Title'
        )
        self.description_input = Input(
            page, locator='create-course-exercise-form-description-{index}-input', name='Description'
        )
