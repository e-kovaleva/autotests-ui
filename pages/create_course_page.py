...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.preview_empty_view_description = page.get_by_test_id(
        ...
        self.create_course_estimatd_time_input = (
    ...
    def check_visible_create_course_form(
        ...
        expect(self.create_course_estimatd_time_input).to_be_visible()
        expect(self.create_course_estimatd_time_input).to_have_value(estimated_time)
    ...
    def check_visible_create_exercise_form(self, index: int, title: str, description: str):
        ...
        exercise_title_input = (
            self.page.get_by_test_id(f'create-course-exercise-form-title-{index}-input').locator('input')
        )
        exercise_description_input = (
            self.page.get_by_test_id('create-course-exercise-form-description-{index}-input').locator('input')
        )
